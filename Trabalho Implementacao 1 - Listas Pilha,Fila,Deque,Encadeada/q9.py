'''Escreva um programa para converter uma express ̃ao aritm ́etica na forma prefixada para
formas infixas e p ́os-fixadas equivalentes.'''
...
def prefixa_infixa_e_posfixa(expressao_prefixa):
    ...
    # Divide a expressão em partes separadas por espaco
